...
!   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    reg_prod_opt = krp * runoff * exp(-(Ea/Rgas)*(1./(temp+273.15)-1./T0))
!   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
!    eq_reg_thick = h0*RPopt/E      ! for inverse law
    eq_reg_thick = max( h0*log(RPopt/E), 0d0 ) ! for exponential function
!   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
!   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    dissolution_constant = Kwest * (1-exp(-kw*runoff)) * exp( (Ea/Rgas) * (1/T0-1/(temp+273.15)) )
!   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
